...
class TestStreamerOrderBy:
    ...
    def test_orderBy_hasNoItems(self,
                                ...
                                iterable,
                                iterable_list):
        assert list(q(iterable).order_by()) == iterable_list
    ...
    def test_orderBy_hasMultipleItems_defaultSorting(self,
                                                     ...
                                                     iterable,
                                                     iterable_list):
        assert list(q(iterable).order_by()) == list(iterable_list)
    ...
    def test_orderBy_hasMultipleItems_customSelector(self,
        ...
        actual = list(q(iterable).order_by(selector=lambda x: (int(x) % 2)))
